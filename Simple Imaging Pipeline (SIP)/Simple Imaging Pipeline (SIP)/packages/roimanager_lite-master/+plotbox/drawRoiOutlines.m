function [hLines, hText] = drawRoiOutlines(ax, roiArray, showNumbers)
%drawRoiOutlines draw outlines of rois in given axes
%
% [hLines] = drawRoiOutlines(ax, roiArray)
...
hLines = plot(ax, roiBoundaryCellArray{:}, 'Color', [0.8, 0.8, 0.8]);

if showNumbers
    numbers = arrayfun(@(i) num2str(i), 1:nRois, 'uni', 0);
    hText = text(ax, centerPosArray(:, 1), centerPosArray(:, 2), numbers', 'Color', [0.8, 0.8, 0.8]);
end
