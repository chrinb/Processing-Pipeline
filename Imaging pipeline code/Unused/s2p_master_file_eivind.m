...
s2p_make_db_eivind; % RUN YOUR OWN MAKE_DB SCRIPT TO RUN HERE

ops0.toolbox_path = '/Users/eivinhen/PhD/Software/MATLAB/calcium_imaging/Suite2P';
...
ops0.RootStorage            = '/Volumes/Experiments/Suite2p_test'; % Suite2P assumes a folder structure, check out README file
ops0.temp_tiff              = '/temp_suite2p/temp.tif'; % copies each remote tiff locally first, into this file
ops0.RegFileRoot            = '/temp_suite2p/';  % location for binary file
ops0.DeleteBin              = 1; % set to 1 for batch processing on a limited hard drive
ops0.ResultsSavePath        = '/Volumes/Experiments/Suite2p_results'; % a folder structure is created inside
ops0.RegFileTiffLocation    = '/Volumes/Experiments/Suite2p_registered'; %'D:/DATA/'; % leave empty to NOT save registered tiffs (slow)
...
ops0.nSVDforROI             = 200; % how many SVD components for cell clustering
